...
/* harmony export */ });
/* harmony import */ var _cardFunctions_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./cardFunctions.js */ "./src/cardFunctions.js");
...
function newCard(task) {
  ...
  lowBtn.addEventListener("click", () => {
    (0,_cardFunctions_js__WEBPACK_IMPORTED_MODULE_0__.updatePriority)(task.priority, "low", dropBtn);
    dropContent.classList.remove("show");
  });
  ...
  midBtn.addEventListener("click", () => {
    (0,_cardFunctions_js__WEBPACK_IMPORTED_MODULE_0__.updatePriority)(task.priority, "mid", dropBtn);
    dropContent.classList.remove("show");
  });
  ...
  highBtn.addEventListener("click", () => {
    (0,_cardFunctions_js__WEBPACK_IMPORTED_MODULE_0__.updatePriority)(task.priority, "high", dropBtn);
    dropContent.classList.remove("show");
  });
  ...
  dateInput.addEventListener("change", () =>
    (0,_cardFunctions_js__WEBPACK_IMPORTED_MODULE_0__.updateDate)(task.dueDate, dateInput.value, dateLabel)
  );
  ...
  delIcon.addEventListener("click", () => {
    cardWrap.remove();
    (0,_cardFunctions_js__WEBPACK_IMPORTED_MODULE_0__.deleteTask)(task);
  });
  ...
  checkbox.addEventListener("change", () => {
    (0,_cardFunctions_js__WEBPACK_IMPORTED_MODULE_0__.updateCheckbox)(task.check, checkbox.checked);
  });
  ...
  (0,_cardFunctions_js__WEBPACK_IMPORTED_MODULE_0__.textareaWrap)(task, txtArea);
  (0,_cardFunctions_js__WEBPACK_IMPORTED_MODULE_0__.updatePriority)(task.priority, task.priority, dropBtn);
  (0,_cardFunctions_js__WEBPACK_IMPORTED_MODULE_0__.updateDate)(task.dueDate, task.dueDate, dateLabel);
  (0,_cardFunctions_js__WEBPACK_IMPORTED_MODULE_0__.updateCheckbox)(checkbox.checked, task.check);

  (0,_cardFunctions_js__WEBPACK_IMPORTED_MODULE_0__.addCard)(task);
  console.log(task);
}
...
/* harmony export */   textareaWrap: () => (/* binding */ textareaWrap),
...
function updateDate(oldValue, newValue, element) {
  const dateFormat = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(newValue), "dd MMM yyyy");
...
function updatePriority(oldValue, newValue, element) {
  switch (newValue) {
    case "low":
      oldValue = "low";
    ...
    case "mid":
      oldValue = "mid";
      element.style.backgroundColor = "#faa53d";
      break;
    case "high":
      oldValue = "high";
      element.style.backgroundColor = "#f87462";
      break;
  }
...
function textareaWrap(task, textarea) {
...
function updateCheckbox(oldValue, newValue) {
  oldValue = newValue;
  updateStorage();
  console.log(oldValue);
}
...
function deleteTask(taskToDelete) {
  const taskIndex = ___WEBPACK_IMPORTED_MODULE_0__.tasks.indexOf(taskToDelete);
  if (taskIndex !== -1) {
    ___WEBPACK_IMPORTED_MODULE_0__.tasks.splice(taskIndex, 1);
  }
  updateStorage();
}

function addCard(taskToAdd) {
  ___WEBPACK_IMPORTED_MODULE_0__.tasks.push(taskToAdd);
  updateStorage();
}

function updateStorage() {
  localStorage.setItem("tasks", JSON.stringify(___WEBPACK_IMPORTED_MODULE_0__.tasks));
  console.log(`This is the array from update ${___WEBPACK_IMPORTED_MODULE_0__.tasks}`);
}
...
/* harmony export */ });
/* harmony import */ var _cardCreate__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./cardCreate */ "./src/cardCreate.js");
...
(() => {
  ...
  if (storedTaskString !== null) {
    ...
    storedTasks.forEach((task) => {
      ...
      (0,_cardCreate__WEBPACK_IMPORTED_MODULE_0__["default"])(new Task(d, dd, p, c, pr));
    });
  }
})();
...
addTask.addEventListener("click", () => (0,_cardCreate__WEBPACK_IMPORTED_MODULE_0__["default"])(new Task()));
