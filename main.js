...
function updateDate(task, newValue, element) {
  const dateFormat = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(newValue), "dd MMM yyyy");
  element.innerHTML = dateFormat;
  task.dueDate = newValue;
  (0,_storageFunctions__WEBPACK_IMPORTED_MODULE_1__["default"])();
...
function createCard(task, project, isNew) {
  const newEl = (e) => {
...
/* harmony export */ });
/* harmony import */ var _defaultClasses__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./defaultClasses */ "./src/defaultClasses.js");
...
function createList(projectID, listTitle) {
  const project = ___WEBPACK_IMPORTED_MODULE_1__.projects.find((e) => e.id === projectID);
  ...
  title.addEventListener("input", () => {
    ...
    (0,_storageFunctions__WEBPACK_IMPORTED_MODULE_3__["default"])();
  });
  ...
  addBtn.addEventListener("click", () => (0,_createCard__WEBPACK_IMPORTED_MODULE_2__["default"])(new _defaultClasses__WEBPACK_IMPORTED_MODULE_0__.Task(), project, true));
...
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! . */ "./src/index.js");
/* harmony import */ var _defaultClasses__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./defaultClasses */ "./src/defaultClasses.js");
/* harmony import */ var _storageFunctions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./storageFunctions */ "./src/storageFunctions.js");
/* harmony import */ var _listFunctions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./listFunctions */ "./src/listFunctions.js");
...
const createProjectBtn = (project) => {
  ...
  btn.addEventListener("click", () => {
    (0,_listFunctions__WEBPACK_IMPORTED_MODULE_4__.clearList)();
    (0,_listFunctions__WEBPACK_IMPORTED_MODULE_4__.allList)(project, btn);
  });
...
function addProject() {
  ...
  addProjectBtn.addEventListener("click", () => {
    const newProject = new _defaultClasses__WEBPACK_IMPORTED_MODULE_2__.Project();
...
class Project {
  constructor(id = ___WEBPACK_IMPORTED_MODULE_0__.projects.length + 1, name = "New Project", tasks = []) {
    this.id = id;
    this.name = name;
    this.tasks = tasks;
  }
...
/* harmony export */ });
/* harmony import */ var _createList__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./createList */ "./src/createList.js");
/* harmony import */ var _listFunctions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./listFunctions */ "./src/listFunctions.js");
...
(() => {
  ...
  for (const project of projects) {
    (0,_listFunctions__WEBPACK_IMPORTED_MODULE_1__.allList)(project);
  }
  // projects.forEach((project) => allList(project));
  // createList(1);
  (0,_createProject__WEBPACK_IMPORTED_MODULE_2__.addProject)();
  projects.forEach((project) => {
    if (project.id !== 1) {
      (0,_createProject__WEBPACK_IMPORTED_MODULE_2__.createProject)(project.id);
    }
  });
})();
...
homeBtn.addEventListener("click", () => {
  (0,_listFunctions__WEBPACK_IMPORTED_MODULE_1__.clearList)();
  projects.forEach((project) => (0,_listFunctions__WEBPACK_IMPORTED_MODULE_1__.allList)(project));
});
...
function allList(project, listTitle) {
  (0,_createList__WEBPACK_IMPORTED_MODULE_1__["default"])(project.id, listTitle);
  project.tasks.forEach((task) => (0,_createCard__WEBPACK_IMPORTED_MODULE_2__["default"])(task, project));
}

function todayList(project) {
  (0,_createList__WEBPACK_IMPORTED_MODULE_1__["default"])(project.id);
  if (task.date === (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(), "dd MMM yyyy")) {
    (0,_createCard__WEBPACK_IMPORTED_MODULE_2__["default"])(task, project);
  }
}

function weekList(project) {
  (0,_createList__WEBPACK_IMPORTED_MODULE_1__["default"])(project.id);
  const thisWeek = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(task.date);
  if (thisWeek) {
    (0,_createCard__WEBPACK_IMPORTED_MODULE_2__["default"])(task, project);
  }
}
