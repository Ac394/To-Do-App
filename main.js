...
/* harmony export */ });
/* harmony import */ var _storageFunctions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./storageFunctions */ "./src/storageFunctions.js");
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! . */ "./src/index.js");
/* harmony import */ var _taskFunctions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./taskFunctions */ "./src/taskFunctions.js");
...
class UI {
  ...
  static createList(projectID) {
    ...
    title.addEventListener("input", () => {
      ...
      document.querySelectorAll(".sidebar-project")[projectID - 1].innerText =
        title.innerHTML;
      _storageFunctions__WEBPACK_IMPORTED_MODULE_0__["default"].saveList();
    });
    ...
    addBtn.addEventListener("click", () => {
      UI.createTask(new _taskFunctions__WEBPACK_IMPORTED_MODULE_2__.Task(), project, true);
      _storageFunctions__WEBPACK_IMPORTED_MODULE_0__["default"].saveList();
    });
  ...
  static updateDate(task, date, element) {
    const dateFormat = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(date), "dd MMM yyyy");
  ...
  static addProjectBtn() {
    const newProject = ___WEBPACK_IMPORTED_MODULE_1__.todoList.addProject();
  ...
  static createAllTasks() {
    UI.clearList();
    ___WEBPACK_IMPORTED_MODULE_1__.todoList.getProjects().forEach((project) => UI.createProjectList(project));
  }

  static createTodayTasks() {
    UI.clearList();
    ___WEBPACK_IMPORTED_MODULE_1__.todoList.getProjects().forEach((project) => {
  ...
  static deleteProjectContainer(project) {
    ...
    ___WEBPACK_IMPORTED_MODULE_1__.todoList.deleteProject(project);
    ___WEBPACK_IMPORTED_MODULE_1__.todoList.updateProjectsID();
    _storageFunctions__WEBPACK_IMPORTED_MODULE_0__["default"].saveList();
    UI.redrawUI();
  }
...
const todoList = _storageFunctions__WEBPACK_IMPORTED_MODULE_0__["default"].getList();
_UI__WEBPACK_IMPORTED_MODULE_1__["default"].initUI();


/***/ }),

/***/ "./src/listFunctions.js":
/*!******************************!*\
  !*** ./src/listFunctions.js ***!
  \******************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class List {
  ...
  addProject(id = this.projects.length, name = "New Project", tasks = []) {
    const newProject = new _projectFunctions__WEBPACK_IMPORTED_MODULE_0__["default"](id, name, tasks);
...
class Project {
  ...
  getTodayTasks() {
    return this.tasks.filter(
      (task) => task.getDate() === (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(), "yyyy-MM-dd")
    );
  }

  getWeekTasks() {
    return this.tasks.filter((task) => (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(task.getDate())));
  }
...
/* harmony export */ });
/* harmony import */ var _listFunctions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./listFunctions */ "./src/listFunctions.js");
...
class Storage {
  static saveList() {
    localStorage.setItem("todoList", JSON.stringify(___WEBPACK_IMPORTED_MODULE_3__.todoList));
  }

  static getList() {
    const storedList = JSON.parse(localStorage.getItem("todoList"));
    const todoList = new _listFunctions__WEBPACK_IMPORTED_MODULE_0__["default"]();
    ...
    if (storedList) {
      ...
      todoList.setProjects(
        todoList
          .getProjects()
          .map((project) => Object.assign(new _projectFunctions__WEBPACK_IMPORTED_MODULE_1__["default"](), project))
      );
      ...
      todoList
        ...
        .forEach((project) =>
          project.setTasks(
            project.getTasks().map((task) => Object.assign(new _taskFunctions__WEBPACK_IMPORTED_MODULE_2__.Task(), task))
          )
        );
    } else {
