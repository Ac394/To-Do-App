...
function newCard(task, project) {
  ...
  lowBtn.addEventListener("click", () => {
    (0,_cardFunctions_js__WEBPACK_IMPORTED_MODULE_0__.updatePriority)(task, "low", dropBtn);
    dropContent.classList.remove("show");
  });
  ...
  midBtn.addEventListener("click", () => {
    (0,_cardFunctions_js__WEBPACK_IMPORTED_MODULE_0__.updatePriority)(task, "mid", dropBtn);
    dropContent.classList.remove("show");
  });
  ...
  highBtn.addEventListener("click", () => {
    (0,_cardFunctions_js__WEBPACK_IMPORTED_MODULE_0__.updatePriority)(task, "high", dropBtn);
    dropContent.classList.remove("show");
  });
  ...
  dateInput.addEventListener("change", () =>
    (0,_cardFunctions_js__WEBPACK_IMPORTED_MODULE_0__.updateDate)(task, dateInput.value, dateLabel)
  );
  ...
  delIcon.addEventListener("click", () => {
    cardWrap.remove();
    (0,_cardFunctions_js__WEBPACK_IMPORTED_MODULE_0__.deleteTask)(task, project);
  });
  ...
  checkbox.addEventListener("change", () => {
    (0,_cardFunctions_js__WEBPACK_IMPORTED_MODULE_0__.updateCheckbox)(task, checkbox.checked, checkbox);
  });
  ...
  (0,_cardFunctions_js__WEBPACK_IMPORTED_MODULE_0__.updatePriority)(task, task.priority, dropBtn);
  (0,_cardFunctions_js__WEBPACK_IMPORTED_MODULE_0__.updateDate)(task, task.dueDate, dateLabel);
  (0,_cardFunctions_js__WEBPACK_IMPORTED_MODULE_0__.updateCheckbox)(task, task.check, checkbox);

  (0,_cardFunctions_js__WEBPACK_IMPORTED_MODULE_0__.addCard)(task, project);
  console.log(project);
}
...
function updateDate(task, newValue, element) {
...
function updatePriority(task, newValue, label) {
  switch (newValue) {
    case "low":
      task.priority = "low";
...
function updateCheckbox(task, newValue, checkbox) {
  task.check = newValue;
...
function deleteTask(taskToDelete, project) {
...
function addCard(taskToAdd, project) {
...
function updateStorage() {
  ...
  console.log(`This is the array from update ${___WEBPACK_IMPORTED_MODULE_0__.projects}`);
}
...
function createList(project) {
  ...
  addBtn.addEventListener("click", () => (0,_cardCreate__WEBPACK_IMPORTED_MODULE_0__["default"])(new _projectFunctions__WEBPACK_IMPORTED_MODULE_1__.Task(), project));
...
/* harmony import */ var _projectFunctions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./projectFunctions */ "./src/projectFunctions.js");
...
(() => {
  (0,_createList__WEBPACK_IMPORTED_MODULE_1__["default"])(projects[0]);
  ...
  if (storedProjectsString !== null) {
    ...
    projects[0].tasks.forEach((task) => {
      ...
      (0,_cardCreate__WEBPACK_IMPORTED_MODULE_0__["default"])(new _projectFunctions__WEBPACK_IMPORTED_MODULE_2__.Task(d, dd, p, c, pr), projects[0]);
    });
  }
})();
