...
(0,_projectCreate__WEBPACK_IMPORTED_MODULE_1__["default"])();
...
function createProject() {
  ...
  projectHeader.appendChild(title, editBtn);
  addBtn.appendChild(addIcon, addText);
  cards.appendChild(cardsContainer, addBtn);
  list.appendChild(projectHeader, cards);
