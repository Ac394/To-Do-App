...
function newCard(task) {
  ...
  (0,_cardFunctions_js__WEBPACK_IMPORTED_MODULE_0__.defaultPriority)(task, dropBtn);
  ...
  lowBtn.addEventListener("click", () => {
    (0,_cardFunctions_js__WEBPACK_IMPORTED_MODULE_0__.changePriority)(dropContent, task, dropBtn, "low");
  });

  const midBtn = newEl("button");
  midBtn.classList.add("mid-pr");
  midBtn.addEventListener("click", () => {
    (0,_cardFunctions_js__WEBPACK_IMPORTED_MODULE_0__.changePriority)(dropContent, task, dropBtn, "mid");
  });

  const highBtn = newEl("button");
  highBtn.classList.add("high-pr");
  highBtn.addEventListener("click", () => {
    (0,_cardFunctions_js__WEBPACK_IMPORTED_MODULE_0__.changePriority)(dropContent, task, dropBtn, "high");
  });
  ...
  (0,_cardFunctions_js__WEBPACK_IMPORTED_MODULE_0__.dateOutput)(task, dateInput, dateLabel);
...
/* harmony export */   dateOutput: () => (/* binding */ dateOutput),
...
function dateOutput(task, input, label) {
  input.value = new Date().toJSON().slice(0, 10);

  const dateUpdate = () => {
    const dateFormat = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(input.value), "dd MMM yyyy");
...
function changePriority(modal, task, el, priority) {
  const priorityUpdate = () => {
    switch (priority) {
      ...
      case "mid":
        task.priority = "mid";
        el.style.backgroundColor = midCol;
        break;
      case "high":
        task.priority = "high";
        el.style.backgroundColor = highCol;
        break;
    }
  };
...
function defaultPriority(task, el) {
  task.priority = "low";
  el.style.backgroundColor = lowCol;
}
